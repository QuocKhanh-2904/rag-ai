import { ArrowUpRight, Eye, EyeOff, ShieldCheck, XCircle } from "lucide-react";
...
function ArticleModerationCard({ article, busy, onApprove, onReject, onHide, onView }) {
  return (
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        description="Admin đọc `GET /api/admin/articles`, duyệt/từ chối/ẩn bài cộng đồng bằng Firebase ID token có custom claim admin=true."
      />
