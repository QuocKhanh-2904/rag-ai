...
from src.ackend.app.schemas.ingest_metadata import IngestMetadata, parse_ingest_metadata_form
from src.backend.app.services.ingest_orchestration_service import IngestOrchestrationService
...
class PdfUrlIngestRequest(IngestMetadata):
    ...
    # Added disease metadata from n8n disease_core workflow
...
async def ingest_pdf(
    ...
    # Added disease metadata from n8n disease_core workflow
    disease_name: str | None = Form(default=None),
    canonical_key: str | None = Form(default=None),
    raw_source: str | None = Form(default=None),
