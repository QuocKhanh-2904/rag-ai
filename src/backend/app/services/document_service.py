...
from src.backend.app.repositories.chunk_repository import ChunkRecord, ChunkRepository
...
from src.backend.app.repositories.source_repository import SourceRepository
from src.backend.app.config.openai_factory import get_openai_client
from src.backend.app.services.checksum_service import canonicalize_url
